...
# app.config['MAIL_USERNAME'] = 'cissecheick22@gmail.com'
# app.config['MAIL_PASSWORD'] = 'bobancisse1991'
# app.config['MAIL_USE_TLS'] = False
# app.config['MAIL_USE_SSL'] = True
#
# mail = Mail(app)
#
# msg = Message('Hello', sender='cissecheick22@gmail.com', recipients=['lesetudeseninde@gmail.com'])
...
def candidat():
    ...
    if request.method == 'POST':
        if request.form.get('section_choix')==None:
            ...
            print "affichier les variables de la session àpres creation du candidat"
            print session['candidat']
